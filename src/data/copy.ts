...
export const defaultPages: Record<PageSlug, PageCopy> = {
  proje: {
    ...
    lead: "Elys Prime, Bulki Yapı güvencesiyle Sultanbeyli'de yükselen, dört bloktan ve 192 daireden oluşan bütüncül bir yaşam projesidir.",
    seoTitle: "Proje Hakkında",
    seoDescription:
      "Elys Prime; Sultanbeyli'de 4 blok, 192 daire ve 35.000 m² inşaat alanına sahip bir yaşam projesi. Mimari yaklaşım, blok kurgusu ve daire çeşitliliği hakkında ayrıntılar.",
    blocks: [
      ...
      h("Kimler için"),
      p("Elys Prime, ilk evini alan çiftlerden çocuklu ailelere, yatırım amaçlı konut arayanlardan Sultanbeyli'de iş yaşamına yakın olmak isteyenlere kadar geniş bir kitleye hitap ediyor. Normal kat, çatı katı ve dubleks tipleriyle farklı hane büyüklüklerine yanıt veren bir daire çeşitliliği sunuyor."),
  ...
  konum: {
    ...
    lead: "Elys Prime, Sultanbeyli Akşemsettin Mahallesi'nde, toplu taşıma bağlantılarına yürüme mesafesinde konumlanıyor.",
    seoTitle: "Konum ve Ulaşım",
    seoDescription:
      "Elys Prime'ın Sultanbeyli'deki konumu: metroya 5 dakika, otobüs durağına 2 dakika yürüme mesafesi, şehir merkezine araçla 6 dakika. Harita ve ulaşım bilgileri.",
    blocks: [
      ...
      p("İstanbul'da konut seçerken ulaşım süresi, dairenin kendisi kadar belirleyicidir. Sultanbeyli'nin bu bölgesi, hem Anadolu Yakası'nın iş merkezlerine hem de raylı sistem üzerinden şehrin geri kalanına makul sürelerde bağlanıyor."),
      h("Çevredeki yaşam"),
  ...
  blog: {
    ...
    label: "Blog",
    title: "Blog",
    lead: "Konut alım süreci, Sultanbeyli'deki yaşam ve projeden güncel notlar.",
    seoTitle: "Blog",
    seoDescription:
      "Elys Prime blogu: konut alım süreci, peşinat ve taksit hesabı, 2+1 ile 3+1 arasında seçim, Sultanbeyli'de ulaşım ve günlük yaşam üzerine rehber yazılar.",
    blocks: [],
  },
