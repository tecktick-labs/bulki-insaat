...
const slides: { image: string; title: string; note: string }[] = [
  ...
  return <section id="vizyon" className="h-dvh snap-start snap-always overflow-hidden bg-[#181a18] text-white">
    <div className="mx-auto flex h-full max-w-[1440px] flex-col px-5 pb-5 pt-24 sm:px-9 sm:pb-8 lg:px-14 lg:pb-10 lg:pt-28">
      <div className="mb-5 grid shrink-0 gap-4 lg:grid-cols-2 lg:items-end">
        ...
        <div className="max-w-md lg:justify-self-end"><p className="text-sm leading-7 text-white/55">Modern mimariyi geniş peyzaj alanları, sosyal yaşam ve aile sıcaklığıyla bir araya getiren bütüncül bir proje.</p><Link href="/proje" className="mt-3 inline-flex items-center gap-2 text-[10px] font-bold uppercase tracking-[.16em] text-[#d8b792] underline-offset-4 hover:underline">Proje künyesini inceleyin <ArrowRight size={13}/></Link></div>
      </div>
